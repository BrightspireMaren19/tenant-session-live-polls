...
> Design notes for **tenant-session-live-polls** — a runnable typescript example that Typed live polling service with tenant lifecycle controls and private participant tokens.
...
- **Feature code** — the actual task: tenant session polling.
